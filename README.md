...
1. Generazione del Dataset (gen_dataset.m)
...
- Modello Sensori: Genera le misure indirette di accelerometro e magnetometro aggiungendo rumore gaussiano bianco (definito dalle varianze reali dei datasheet commerciali). I dati completi e le matrici di covarianza ottime ($Q_{true}$ e $R_{true}$) vengono salvati nel file dataset_elicottero.mat.2. 
